...
### SOT-008 — Verify Scout and Responder roles use Moltbook /home endpoint
Status: `done`  
Date: 2026-03-06  
Result: Updated both role documentation files to properly reference and implement the Moltbook /home endpoint
Changed Files:
...
Status: `done`  
Date: 2026-02-27  
Result: Created poster.sh script for automated posting with FIFO selection and logging
Changed Files:
- scripts/poster.sh
- references/tasks/SOT-007.md
